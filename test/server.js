...
seneca.add('role:v1,cmd:request',function(args,done){
  ...
  var url_dandelion = "https://api.dandelion.eu/datatxt/nex/v1/?min_confidence=0.1&social.parse_hashtag=False&text="+args.q+"&include=image%2Cabstract%2Ctypes%2Ccategories%2Clod&country=-1&$app_id="+app_id+"&$app_key="+app_key;
